...
    // --- КЛЮЧОВІ ЗМІНИ ТУТ ---
    // 1. Автоматично "логінимо" нового користувача
    localStorage.setItem('loggedInUser', JSON.stringify(newUser));

    setSuccessMessage('Реєстрація успішна! Ви будете перенаправлені в Особистий кабінет.');
    // 2. Перенаправляємо на сторінку Особистого кабінету
    setTimeout(() => {
      navigate('/personal-area'); // Змінено з '/login' на '/personal-area'
    }, 2000);
  };
